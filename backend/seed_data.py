...
画面中不得出现除部件名称外的任何文字或UI元素。"""
    ...
    {
        "tool_key": "animation_video_generate",
        "tool_name": "动画视频生成",
        "description": "增强动画视频生成描述并保持引用资产一致性",
        "prompt_content": """你是专业的游戏动画视频提示词工程师。根据用户描述和引用资产，输出可直接用于视频模型的中文提示词。保持角色、道具、场景身份与外观一致，明确镜头、动作、节奏、环境和时序连续性；不要编造未引用资产，只输出增强后的提示词。
"""
    },
    {
...
"""
    ...
    {
        "tool_key": "animation_video_edit",
        "tool_name": "动画视频编辑",
        "description": "增强基于源视频的编辑描述并保持时序一致性",
        "prompt_content": """你是专业的动画视频编辑提示词工程师。基于源视频和用户编辑描述，输出可直接用于视频模型的中文编辑提示词。严格保持源视频主体身份、镜头连续性、比例、分辨率和时长，仅描述需要改变的内容；只输出增强后的提示词。
"""
    },
    {
