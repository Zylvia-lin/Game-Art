...
游戏精灵图风格，清晰轮廓，高细节材质纹理。
画面中不得出现任何文字、UI元素、或其他角色。'),
('animation_video_generate', '动画视频生成', '增强动画视频生成提示词', '保持引用资产一致性，明确镜头、动作、节奏和时序连续性，只输出增强后的中文视频提示词。'),
...
('animation_video_edit', '动画视频编辑', '增强基于源视频的编辑提示词', '严格保持源视频主体身份、镜头连续性、比例、分辨率和时长，只输出增强后的中文编辑提示词。'),
